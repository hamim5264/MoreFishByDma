...
class FishDiseaseTreatmentController extends GetxController {
  var titleList = [
    ...
    FishDiseaseTreatmentData.title5,
    FishDiseaseTreatmentData.title6,
    FishDiseaseTreatmentData.title7,
  ...
  var dataList = [
    ...
    FishDiseaseTreatmentData.dataList5,
    FishDiseaseTreatmentData.dataList6,
    FishDiseaseTreatmentData.dataList7,
